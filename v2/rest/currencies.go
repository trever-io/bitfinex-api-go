...
func (cs *CurrenciesService) Conf(label, symbol, unit, explorer, pairs, methods, fees, info bool) ([]currency.Conf, error) {
	...
	if info {
		segments = append(segments, string(currency.InfoMap))
	}
